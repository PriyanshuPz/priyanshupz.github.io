...
My mother used to call me _mechanic_ because I kept opening things. old Heaters. TVs. Anything with screws. Most survived. Some didn’t.
...
I discovered Unity and began building small indie games — mostly unfinished, all educational. I followed tutorials like this excellent [playlist](https://www.youtube.com/playlist?list=PLPV2KyIb3jR53Jce9hP7G5xC4O9AgnOuL) and learned by shipping imperfect things.
...
I write occasionally on [Dev.to](https://dev.to/priyanshuverma). Some of it has reached more people than I expected.
...
Around that period, I started [P8labs](https://github.com/p8labs) as a place to keep the projects I was building. I didn’t overthink it — I just needed a home for my work.
...
More recently, I’ve been getting deeper into electronics and low-level programming. Software began to feel incomplete without understanding the layers beneath it. That led me to build things like [Piperpad](/projects/piperpad).
